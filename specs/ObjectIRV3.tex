...
\begin{notebox}
Arrays in ObjectIR v2 are Static typed and variable-length. Typed array variants
...
self host runtimes and such as of this documents date of publishing.
...
\begin{itemize}[leftmargin=1.8em]
  ...
  \item \textbf{Typed arrays.} All arrays are typed. Distinct
    \texttt{int[]}, \texttt{float[]}, etc. are available for use. hower runtimes must implement type safety.
